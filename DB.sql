...
ALTER TABLE EMD convert to charset utf8;
ALTER TABLE USER convert to charset utf8;
ALTER TABLE RECIPE_CONTENT convert to charset utf8;
ALTER TABLE VEGE_CONTENT convert to charset utf8;
ALTER TABLE COMMENT convert to charset utf8;
ALTER TABLE IMG_INFO convert to charset utf8;
ALTER TABLE VOTE_CONTENT convert to charset utf8;